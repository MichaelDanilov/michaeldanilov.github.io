...
$().ready(function() {
	...
	$('.dnlv-addToList').click(function() {
		...
		if (window.error.getStatus() === true && window.error.getId() !== undefined) {
			...
			var b = (window.ytShownote.ytVideo.startTime !== undefined) ? window.ytShownote.ytVideo.startTime + ' с.' : '';
			var c = (window.ytShownote.ytVideo.endTime !== undefined) ? window.ytShownote.ytVideo.endTime + ' с.' : '';
			var d = '<tr class="info"><td class="span6">' + a + '</td><td class="span1">' + b + '</td><td class="span1">' + c + '</td><td class="span1"><div class="btn btn-danger btn-mini dnlv-delete">удалить</div></td></tr>';
